...
fn bindgen_test_layout_Bytes() {
    const UNINIT: ::std::mem::MaybeUninit<Bytes> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
...
#[test]
fn bindgen_test_layout_BytesWithError() {
    const UNINIT: ::std::mem::MaybeUninit<BytesWithError> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<BytesWithError>(),
        24usize,
        concat!("Size of: ", stringify!(BytesWithError))
    );
    assert_eq!(
        ::std::mem::align_of::<BytesWithError>(),
        8usize,
        concat!("Alignment of ", stringify!(BytesWithError))
    );
    assert_eq!(
...
pub type ContractId = Bytes;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct Address {
    pub address: [::std::os::raw::c_uchar; 33usize],
}
#[test]
...
#[test]
fn bindgen_test_layout_SimulatorCallContext() {
    const UNINIT: ::std::mem::MaybeUninit<SimulatorCallContext> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<SimulatorCallContext>(),
        120usize,
        concat!("Size of: ", stringify!(SimulatorCallContext))
    );
    assert_eq!(
        ::std::mem::align_of::<SimulatorCallContext>(),
        8usize,
        concat!("Alignment of ", stringify!(SimulatorCallContext))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).contract_address) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(SimulatorCallContext),
            "::",
            stringify!(contract_address)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).actor_address) as usize - ptr as usize },
        33usize,
        concat!(
            "Offset of field: ",
            stringify!(SimulatorCallContext),
            "::",
            stringify!(actor_address)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).max_gas) as usize - ptr as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(SimulatorCallContext),
...
#[test]
fn bindgen_test_layout_CallContractResponse() {
    const UNINIT: ::std::mem::MaybeUninit<CallContractResponse> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CallContractResponse>(),
        32usize,
        concat!("Size of: ", stringify!(CallContractResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<CallContractResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(CallContractResponse))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).error) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(CallContractResponse),
            "::",
            stringify!(error)
        )
    );
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fuel) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(CallContractResponse),
...
#[test]
fn bindgen_test_layout_CreateContractResponse() {
    const UNINIT: ::std::mem::MaybeUninit<CreateContractResponse> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<CreateContractResponse>(),
        64usize,
        concat!("Size of: ", stringify!(CreateContractResponse))
    );
    assert_eq!(
        ::std::mem::align_of::<CreateContractResponse>(),
        8usize,
        concat!("Alignment of ", stringify!(CreateContractResponse))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).error) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(CreateContractResponse),
            "::",
            stringify!(error)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).contract_id) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(CreateContractResponse),
...
pub type GetStateCallback = ::std::option::Option<
    unsafe extern "C" fn(data: *mut ::std::os::raw::c_void, key: Bytes) -> BytesWithError,
>;
pub type InsertStateCallback = ::std::option::Option<
    unsafe extern "C" fn(
...
>;
pub type RemoveStateCallback = ::std::option::Option<
    unsafe extern "C" fn(
        data: *mut ::std::os::raw::c_void,
        key: Bytes,
    ) -> *mut ::std::os::raw::c_char,
...
#[derive(Debug, Copy, Clone)]
pub struct Mutable {
    pub stateObj: *mut ::std::os::raw::c_void,
    pub get_value_callback: GetStateCallback,
    pub insert_callback: InsertStateCallback,
    pub remove_callback: RemoveStateCallback,
}
#[test]
fn bindgen_test_layout_Mutable() {
    const UNINIT: ::std::mem::MaybeUninit<Mutable> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<Mutable>(),
        32usize,
        concat!("Size of: ", stringify!(Mutable))
    );
    assert_eq!(
        ::std::mem::align_of::<Mutable>(),
        8usize,
        concat!("Alignment of ", stringify!(Mutable))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).stateObj) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Mutable),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).get_value_callback) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Mutable),
            "::",
            stringify!(get_value_callback)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).insert_callback) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(Mutable),
            "::",
            stringify!(insert_callback)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn copy_bytes(data: *const ::std::os::raw::c_void, size: usize) -> Bytes;
}
extern "C" {
    pub fn get_value(
        state: *mut Mutable,
...
extern "C" {
    pub fn bridge_get_callback(
        callback: GetStateCallback,
        stateObj: *mut ::std::os::raw::c_void,
        key: Bytes,
    ) -> BytesWithError;
}
extern "C" {
    pub fn bridge_insert_callback(
        insertFuncPtr: InsertStateCallback,
        dbPtr: *mut ::std::os::raw::c_void,
        key: Bytes,
        value: Bytes,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn bridge_remove_callback(
        removeFuncPtr: RemoveStateCallback,
        dbPtr: *mut ::std::os::raw::c_void,
        key: Bytes,
    ) -> *mut ::std::os::raw::c_char;
}
extern "C" {
    pub fn new_mutable(
        stateObj: *mut ::std::os::raw::c_void,
        get_cb: GetStateCallback,
        insert_cb: InsertStateCallback,
        remove_cb: RemoveStateCallback,
    ) -> Mutable;
}
