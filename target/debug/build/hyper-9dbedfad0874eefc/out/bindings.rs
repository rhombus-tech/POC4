...
extern "C" {
    pub fn hypersdk_init_runtime(config: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn hypersdk_deploy_contract(
        wasm_bytes: *const u8,
        wasm_len: usize,
        contract_id: *mut u8,
    ) -> ::std::os::raw::c_int;
...
extern "C" {
    pub fn hypersdk_free_buffer(ptr: *mut ::std::os::raw::c_void);
}
